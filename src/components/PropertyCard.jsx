...
// Enhanced with comprehensive SEO optimizations
...
// ✅ NEW: Generate Property-Specific Schema
...
export default function PropertyCard({ property }) {
  ...
  // ✅ SEO: Generate enhanced alt text
  ...
  // ✅ SEO: Generate property card schema
  const propertySchema = generatePropertyCardSchema(property, images);

  return (
    <>
      {/* ✅ SEO: Inject Schema for this specific property card */}
      <Helmet>
      ...
      >
        {/* ✅ SEO: Hidden Microdata for Crawlers */}
        ...
        >
          ...
          >
            ...
            <div className="p-5 flex flex-col flex-grow justify-between">
              <div>
                <h2
                  className="text-lg font-bold text-gray-900 dark:text-gray-100 line-clamp-1 mb-1 leading-tight"
                  itemProp="name"
                >
                  {property.title}
                </h2>
            ...
            <div className="relative z-10 flex flex-col h-full p-6 items-center justify-center text-center text-gray-900 dark:text-white">
              ...
              <button
                ...
                aria-label={isSoldOrRented
                  ...
                  : `View full details for ${property.title} in ${property.location}`}
              >
