      ...
      >
        ...
        >
          ...
          <div className="p-5 flex flex-col flex-grow justify-between">
            <div>
              <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100 line-clamp-1 mb-1">
                {property.title}
              </h2>
              <p className="text-gray-600 dark:text-gray-400 text-sm line-clamp-1 flex items-center gap-1">
                 {property.location}
              </p>
            </div>
            ...
            {/* Footer Cue */}
            <div className="mt-3 w-full py-2 rounded-lg text-xs font-semibold flex items-center justify-center gap-2 transition-colors
              bg-gray-100/80 text-gray-600 border border-gray-200
              dark:bg-white/5 dark:text-gray-300 dark:border-gray-700
              group-hover:bg-blue-50 dark:group-hover:bg-blue-900/20 group-hover:text-blue-600 dark:group-hover:text-blue-400">
               Tap to View Owner <FaInfoCircle />
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col h-full p-6 items-center justify-center text-center text-gray-900 dark:text-white">
            ...
            {/* Listed By Section */}
            <div className="mb-6">
                <h4 className="text-xs font-bold uppercase tracking-widest mb-3 text-gray-500 dark:text-blue-300/80">
                    Listed By
                </h4>
                <div className="flex flex-col items-center">
                    <div className="w-20 h-20 rounded-full p-1 mb-3 shadow-md border bg-white dark:bg-white/10 border-gray-200 dark:border-white/20 backdrop-blur-md">
                        <img 
                           src={agentImage} 
                           alt={agentName} 
                    ...
                    <span className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                       {property.agent ? 'Registered Agent' : 'Private Owner'}
                    </span>
                </div>
            </div>

            {/* Availability Status */}
            <div className={`mb-8 px-4 py-1.5 rounded-full text-xs font-bold border uppercase tracking-wide backdrop-blur-md ${
            ...
            >
              {isSoldOrRented ? 'View Archive' : 'View Full Details'} <FaArrowRight />
            </button>
