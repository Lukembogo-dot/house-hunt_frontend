...
import { 
  ...
  FaExclamationTriangle, FaWalking, FaMotorcycle, FaSignal
} from 'react-icons/fa';
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                     ...
                     <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <span className="text-xs font-bold bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded text-gray-700 dark:text-gray-300">{score.management?.caretakerFriendliness || 'Professional'}</span>
                        </div>
                     </div>
                 </div>
