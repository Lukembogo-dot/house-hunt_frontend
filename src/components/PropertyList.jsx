...
const PromoFlipCard = ({ frontContent, backContent, accentColor, onClick }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={`absolute inset-0 backface-hidden w-full h-full rounded-2xl shadow-xl overflow-hidden flex flex-col items-center justify-center p-8 text-center 
        ...
        <div 
          className={`absolute inset-0 backface-hidden w-full h-full rounded-2xl shadow-xl overflow-hidden flex flex-col items-center justify-center p-8 text-center 
            ...
            dark:bg-slate-900/60 dark:border-white/20 rotate-y-180`}
          ...
          if (index === 1) {
            return (
              <div key={`promo-community-${index}`} style={{ display: 'contents' }}>
                <PromoFlipCard
                  accentColor="purple"
                  onClick={() => navigate('/share-insight', { state: { location: activeFilters.location, type: 'question' } })}
                  frontContent={
                    <>
                  ...
                  backContent={
                    <>
                      ...
                      <button className="w-full bg-purple-600 hover:bg-purple-500 text-white font-bold py-3.5 px-6 rounded-xl shadow-lg transition transform hover:-translate-y-1 flex items-center justify-center gap-2 border border-purple-400/50">
                ...
                <PromoFlipCard
                  ...
                  backContent={
                    <>
                      ...
                      <button className="w-full bg-yellow-500 hover:bg-yellow-400 text-black font-bold py-3.5 px-6 rounded-xl shadow-lg transition transform hover:-translate-y-1 flex items-center justify-center gap-2 border border-yellow-400/50">
                ...
                <PromoFlipCard
                  ...
                  backContent={
                    <>
                      ...
                      <button className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-3.5 px-6 rounded-xl shadow-lg transition transform hover:-translate-y-1 flex items-center justify-center gap-2 border border-blue-400/50">
