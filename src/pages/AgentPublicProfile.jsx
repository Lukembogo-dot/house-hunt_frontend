...
const AgentSeoInjector = ({ seo, agent }) => {
  ...
  const agentSchema = {
    ...
    "priceRange": "$$-$$$$", // Generic price range for Real Estate
    ...(socialUrls.length > 0 && { "sameAs": socialUrls }),
    ...(agent.numReviews > 0 && {
      "aggregateRating": {
        "@type": "AggregateRating",
        "ratingValue": agent.averageRating,
        "reviewCount": agent.numReviews
      }
    }),
  };
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="text-center md:text-left flex-1">
              ...
              <div className="flex flex-col md:flex-row items-center md:items-start gap-3 text-gray-600 dark:text-gray-300 mb-4">
                {/* ✅ NEW: Agent Type Badge */}
                <span className={`px-2 py-0.5 rounded text-xs font-bold uppercase tracking-wide border ${agent.agentType === 'Agency'
                  ...
                  {agent.agentType === 'Agency' ? 'Agency' : 'Freelance Agent'}
                </span>
                <span className="hidden md:inline text-gray-300">•</span>

                <span className="flex items-center gap-1.5 font-medium"><FaBuilding className="text-gray-400" /> {agent.companyName || "Independent"}</span>
                <span className="hidden md:inline text-gray-300">•</span>
