...
// (UPDATED: Removed technical/SEO jargon from UI)

import React, { useState, useEffect } from 'react';
import { useNavigate, useLocation, Link } from 'react-router-dom';
import { Helmet } from 'react-helmet-async';
import { FaPenNib, FaMapMarkerAlt, FaUser, FaPaperPlane, FaCheckCircle, FaSpinner } from 'react-icons/fa';
...
const ShareInsight = () => {
  ...
  // Check if location was passed via state or query param (e.g. from DynamicSearchPage)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // POST to the new community endpoint
      ...
      if (data.success) {
        ...
        setStatus('success');
        // Clear form
        setFormData({ title: '', location: '', authorName: '', content: '' });
      }
    } catch (err) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center p-4">
        <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg max-w-md w-full text-center border border-green-100 dark:border-gray-700">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Published Successfully!</h2>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 py-12 px-4 sm:px-6 lg:px-8">
      <Helmet>
        <title>Share a Neighborhood Insight | HouseHunt Kenya</title>
        <meta name="description" content="Share your experience living in different neighborhoods in Nairobi. Help others find their perfect home." />
      </Helmet>
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. Why I love living in Kilimani..."
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Write your review here. What is the vibe like? How is the security, water, and accessibility?"
              ></textarea>
            </div>
            ...
            >
              {status === 'submitting' ? (
                ...
                <>
                  <FaPaperPlane className="mr-2" /> Publish Insight
                </>
              )}
            </button>
          </form>
