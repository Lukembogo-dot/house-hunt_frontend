  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // ✅ UPDATED: Changed path to singular '/neighbourhood/'
      ...
      <div className="bg-purple-900 text-white pt-12 pb-16 px-6 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
           ...
           <p className="text-lg text-purple-100 max-w-2xl mx-auto">
             The honest truth about <strong>{locationName}</strong>. Read verified reviews from real residents about safety, water reliability, and connectivity.
           </p>
        </div>
      </div>
