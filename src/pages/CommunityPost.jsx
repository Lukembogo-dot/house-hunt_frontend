...
import { FaMapMarkerAlt, FaUser, FaCalendarAlt, FaArrowLeft, FaThumbsUp, FaReply, FaSpinner, FaQuestionCircle, FaCommentDots } from 'react-icons/fa';
...
const CommunityPost = () => {
  ...
  const [votingMap, setVotingMap] = useState({}); // Local tracking to prevent spam clicking
  ...
  // ✅ HANDLER: Vote on Post or Reply
  const handleVote = async (replyId = null) => {
    const key = replyId || 'main';
    if (votingMap[key]) return; // Prevent double voting in session
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 py-10 px-4">
      ...
      <article className="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-100 dark:border-gray-700">
        ...
        {/* Footer CTA */}
        <div className="bg-white dark:bg-gray-800 p-8 border-t border-gray-100 dark:border-gray-700 text-center">
          ...
          <Link 
            ...
            className="inline-block bg-purple-100 hover:bg-purple-200 text-purple-700 dark:bg-purple-900/30 dark:hover:bg-purple-900/50 dark:text-purple-300 font-bold py-3 px-6 rounded-lg transition"
          >
            {isQuestion ? 'Ask a New Question' : 'Write a Neighborhood Review'}
          </Link>
        </div>
